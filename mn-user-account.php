		...
		<div class=" backgroundimage" style="background-repeat:repeat">
			...
			<!-- second row  personal  -->
				...
				<!--  Personal setting  -->
						<div class="col-md-2" style="margin-top:1em; float: left">
							<div class="user-info">
								...
								<div class="btn-ice2" align="center" style="color:black"><p></p><i class="fa fa-cog fa=spin"></i><strong>Account</strong></div>
				...
				<!-- Favorites need data -->
						...
						<div class="col-md-10">
						    <div class="row" style="font-size:30px; margin:5px 0 0 0;border-bottom:1px solid black;"> Setting</div>
						    <div class="row">
						    	<div class="container-pw">
						    		<div class="change-pw">
						    			<form>
										    <div id="old-pw" class="group">      
										    ...
										    <div id="new-pw"class="group">      
										      <input type="text" required>
										      <span class="highlight"></span>
										      <span class="bar"></span>
										      <label>New password</label>
										    </div>
										    <div id="nick-name"class="group">      
										      <input type="text" required>
										      <span class="highlight"></span>
										      <span class="bar"></span>
  										...
  										<button style="margin-left:170px;margin-right:30px">Save</button>
