                ...
                <!-- Collect the nav links, forms, and other content for toggling -->
                    <div class="collapse navbar-collapse" id="navigation-default2">
                      ...
                      <ul class="nav navbar-nav navbar-right">
                            <li><button class="btn btn-round btn-fill btn-info" data-toggle="modal" onclick="window.location.href='mn-signout.php'"><i class="fa fa-sign-in"></i>&nbsp&nbspSign Out</button></li>
                       </ul>
                            ...
                            <div class="content">
                                <div class="author">
                                    ...
                                    <img id="restaurant image"class=" col-sm-4 col-sm-offset-4 col-xs-6 col-xs-offset-3 text-center" src="image/newbee.png" alt="..." >                       
                                      <h4 class="name text-center col-md-2 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-6 col-xs-offset-3">#restaurant name#<br />
                                         <small>#restaurant address#</small>
                                      </h4> 
                                    </a>
                                </div>  
                                <p class="description text-center col-md-2 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-6 col-xs-offset-3"> #restaurant profile data# 
                                </p>
                            </div>
                            <hr>
