		...
		<div class=" backgroundimage" style="background-repeat:repeat">
			...
			<!-- second row  personal  -->
				...
				<!-- Favorites need data -->
						...
						<div class="col-md-10">
						    <div class="row" style="font-size:30px; margin:5px 0 0 0;border-bottom:1px solid black;"> Favorites</div>
							<div class="grid">

				<!-- 需要菜的图片，名字-->
				
								<figure class="effect-chico thumbnail" style="margin-right:3px">
									<img src="image/2.jpg" style="height:160px;" />
									<figcaption>
										<p>O.M.Y</p>
										<a href="mn-dish-detail.php">View more</a>
									</figcaption>			
								</figure>
								<figure class="effect-chico thumbnail" style="margin-right:3px">
									<img src="image/6.jpg" style="height:160px"/>
									<figcaption>
										<p>PASTA</p>
										<a href="#">View more</a>
									</figcaption>			
